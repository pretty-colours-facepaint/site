...
<?php site_header(); ?>
  ...
  <section class="max-w-3xl mx-auto px-4 py-16">
    ...
    <div class="relative isolate">
      ...
      <a href="aanvraag.html" class="price-card relative z-10 border rounded-xl shadow-sm text-center p-8 flex flex-col items-center transition cursor-pointer" style="--card-bg-light:rgb(253,238,246);--card-bg-medium:rgb(252,217,234);">
        ...
        <h3 class="font-display text-2xl text-pink-600 mb-1">Schminken</h3>
        <p class="text-xl font-semibold text-gray-800 mb-2">€ 1,-</p>
        <p class="text-gray-500 text-sm">Placeholder tekst over de schminkprijzen.</p>
      </a>
      <a href="aanvraag.html" class="price-card relative z-10 border rounded-xl shadow-sm text-center p-8 flex flex-col items-center transition cursor-pointer" style="--card-bg-light:rgb(244,240,248);--card-bg-medium:rgb(230,221,239);">
        ...
        <h3 class="font-display text-2xl text-purple-600 mb-1">Glittertattoo's</h3>
        <p class="text-xl font-semibold text-gray-800 mb-2">€ 2,-</p>
        <p class="text-gray-500 text-sm">Placeholder tekst over de glittertattoo-prijzen.</p>
      </a>
      <a href="aanvraag.html" class="price-card relative z-10 border rounded-xl shadow-sm text-center p-8 flex flex-col items-center transition cursor-pointer" style="--card-bg-light:rgb(245,249,238);--card-bg-medium:rgb(233,242,216);">
        <div class="w-48 h-48 mb-4 icon-spin-mask" style="overflow:hidden;<?= mask_style('<path fill-rule="evenodd" clip-rule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.006 5.404.434c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.434 2.082-5.005Z" />') ?>">
          <img src="assets/example-feest.jpg" alt="Voorbeeld feest" class="w-full h-full object-cover icon-spin-counter">
        </div>
        <h3 class="font-display text-2xl text-green-600 mb-1">Feestjes &amp; evenementen</h3>
        <p class="text-xl font-semibold text-gray-800 mb-2">€ 3,-</p>
        <p class="text-gray-500 text-sm">Placeholder tekst over de prijzen voor feestjes etc.</p>
      </a>
    </div>
      <img src="assets/splash-left.jpg" alt="" class="hidden lg:block absolute -z-10 -left-20 top-1/2 -translate-y-1/2 w-24 pointer-events-none select-none" aria-hidden="true">
      <img src="assets/splash-right.jpg" alt="" class="hidden lg:block absolute -z-10 -right-20 top-1/2 -translate-y-1/2 w-24 pointer-events-none select-none" aria-hidden="true">
    </div>

    <p class="text-center text-gray-500 text-sm mt-16">Placeholder tekst: neem contact op voor een offerte op maat.</p>
  </section>

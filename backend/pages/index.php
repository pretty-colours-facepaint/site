  ...
  <section id="over" class="max-w-5xl mx-auto px-4 pb-20">
    <div class="border border-orange-100 rounded-2xl p-6 sm:p-10 flex flex-col sm:flex-row items-center gap-8 bg-orange-50" style="background-color: #fdf9f5;">
      ...
      <div class="text-center sm:text-left">
        ...
        <?php rainbow_button(content_config('contact.ctaAanvraag') . ' ' . mail_icon_svg('size-4 inline align-text-bottom ml-2', strokeWidth: 2.5), 'solid', href: 'pages/aanvraag.html', extraClass: 'inline-block px-8 py-4 text-sm font-medium'); ?>
      </div>
    </div>
  </section>
<?php footer_full(); ?>

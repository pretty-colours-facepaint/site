...
$ogImage = "https://prettycolours-facepaint.nl/MAAK_HIER_AANPASSINGEN/portfolio/kwast/cover.jpg";
?>
<!DOCTYPE html>
<html lang="nl">
<head>
...
<?php site_header(onHome: true); ?>
  ...
  <section id="werk" class="max-w-5xl mx-auto px-4 pt-16 pb-14">
    <div class="grid sm:grid-cols-3 gap-6 text-center">
      <div >
        ...
        <h3 class="font-display text-3xl mb-1 text-pink-600"><?= content_config('homepage.hartIcon.titel') ?></h3>
        <p class="pt-6 text-sm text-gray-500"><?= content_config('homepage.hartIcon.tekst') ?></p>
      </div>
      <div>
        <img src="assets/icon-glittertattoo.png" alt="" class="w-14 h-14 rounded-full mx-auto mb-3 shadow-sm">
        <h3 class="font-display text-3xl mb-1 text-purple-600"><?= content_config('homepage.bliksemIcon.titel') ?></h3>
        <p class="pt-6 text-sm text-gray-500"><?= content_config('homepage.bliksemIcon.tekst') ?></p>
      </div>
      <div>
        <img src="assets/icon-feest.png" alt="" class="w-14 h-14 rounded-full mx-auto mb-3 shadow-sm">
        <h3 class="font-display text-3xl mb-1 text-green-600"><?= content_config('homepage.sterIcon.titel') ?></h3>
        <p class="pt-6 text-sm text-gray-500"><?= content_config('homepage.sterIcon.tekst') ?></p>
      </div>
    </div>
    ...
    <div class="relative">
      ...
      <div class="relative z-10 grid sm:grid-cols-3 gap-6 mt-8">
        <a href="pages/werk-schminken.html">
          <img <?= content_config_image('covers.hartIcon') ?> alt="Voorbeeld schminken" class="aspect-square w-full object-cover rounded-xl shadow-sm hover:opacity-90 transition">
        </a>
        <a href="pages/werk-glittertattoos.html">
          <img <?= content_config_image('covers.bliksemIcon') ?> alt="Voorbeeld glittertattoo" class="aspect-square w-full object-cover rounded-xl shadow-sm hover:opacity-90 transition">
        </a>
        <a href="pages/werk-feesten-events.html">
          <img <?= content_config_image('covers.sterIcon') ?> alt="Voorbeeld feest" class="aspect-square w-full object-cover rounded-xl shadow-sm hover:opacity-90 transition">
        </a>
      </div>
    </div>
    ...
    <div class="flex flex-col sm:flex-row gap-4 justify-center mt-10">
      <a href="pages/werk.html" class="inline-flex items-center justify-center gap-2 border-2 border-pink-500 text-pink-600 rounded-full px-8 py-4 text-sm text-center font-medium hover:bg-pink-500/10 transition">
  ...
  <section id="over" class="max-w-5xl mx-auto px-4 pb-20">
    <div class="border border-orange-100 rounded-2xl p-6 sm:p-10 flex flex-col sm:flex-row items-center gap-8 bg-orange-50" style="background-color: #fdf9f5;">
      <img <?= content_config_image('covers.portret') ?> alt="Portret" class="w-56 h-56 sm:w-64 sm:h-64 rounded-full object-cover shrink-0 ">
